...
if oil_ok then
  ...
  oil.setup({
    ...
    keymaps = {
      ...
      ["gd"] = function()
        if columns_full_info then
          require("oil").set_columns({ "icon" })
          columns_full_info = false
        else
          require("oil").set_columns({ "icon", "permissions", "size", "mtime" })
          columns_full_info = true
        end
      end,
      ...
      ["<leader>ef"] = {
        ...
        mode = "n",
        nowait = true,
        desc = "[E]xplorer [f]ind files in the current directory"
      },

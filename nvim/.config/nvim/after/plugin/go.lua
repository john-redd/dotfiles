local guihua_ok, guihua = pcall(require, "guihua")
if guihua_ok then
	guihua.setup()
end
...
if go_ok then
	go.setup({
		...
		-- tag_options = "json=omitempty", -- JR: I think this is what changed the radial-atlas stuff
...
-- end, { desc = "[d]ebug [t]est", silent = true, remap = false })
--
-- vim.keymap.set("n", "<leader>gr", function()
-- 	local full_cmd = "silent !tmux send -t \\" .. tmux_pane_id .. " '" .. default_run_cmd .. "' Enter"
-- 	vim.api.nvim_command(full_cmd)
...
vim.keymap.set("n", "<leader>gts", "<cmd>GoTestSum<CR>", { desc = "Run :GoTestSum" })
vim.keymap.set("n", "<leader>gtr", "<cmd>GoTest<CR>", { desc = "Run :GoTest" })
vim.keymap.set("n", "<leader>gtp", "<cmd>GoTestPkg<CR>", { desc = "Run :GoTestPkg" })
vim.keymap.set("n", "<leader>gta", "<cmd>GoTestAdd<CR>", { desc = "Run :GoTestAdd" })
vim.keymap.set("n", "<leader>gs", "<cmd>GoFillStruct<CR>", { desc = "Run :GoFillStruct" })
vim.keymap.set("n", "<leader>gd", "<cmd>GoDoc<CR>", { desc = "Run :GoDoc" })
vim.keymap.set("n", "<leader>gdo", "<cmd>GoDocBrowser<CR>", { desc = "Run :GoDocBrowser" })

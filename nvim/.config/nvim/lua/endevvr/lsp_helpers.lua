local function create_set(list)
	...
	for _, l in ipairs(list) do
		set[l] = true -- Store the value as a key with a truthy value
	end
	return set
end

local disable_formatting_list = { "gopls", "golangci-lint-langserver" }
local disable_formatting_set = create_set(disable_formatting_list)
